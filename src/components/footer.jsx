export default function Footer() {
  return (
    <>
      <footer>
        <div className="footerBg py-20 flex justify-center  flex-wrap">
          <div className="xl:w-2/12 max-sm:w-10/12 max-sm:flex max-sm:justify-center">
          ...
          <div className=" xl:w-2/12 xl:ms-5 space-y-5 max-sm:w-10/12 max-sm:my-5 ">
          ...
          <div className=" xl:w-3/12 space-y-5 max-sm:w-10/12 max-sm:my-5 ">
            <h4 className="font text-white font-semibold text-xl">Instagram</h4>
            <hr className=" w-14 "></hr>
          ...
          <div className=" xl:w-2/12 space-y-5">
